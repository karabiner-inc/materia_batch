defmodule MateriaBatch.BatchManagerTest do
  ...
  describe "job life cycle" do
    ...
    test "job create" do
      ...
      job_schedules =
        JobSchedules.list_job_schedules_by_params(%{"and" => [], "or" => [%{"job_code" => "SleepDammy1"}]})
      ...
      assert results == [
               %{
                 ...
                 error_action: "abort",
                 function: "sleep",
                 job_code: "SleepDammy1",
                 lock_version: 0,
                 module: "Process",
                 name: "スリープダミー１",
                 next_check_datetime: "#DateTime<2019-03-04 09:00:00.000000Z>",
                 params: "500",
                 priority: 100,
                 reschedule_period_sec: 60,
                 result: nil,
                 schedule_datetime: "#DateTime<2019-03-04 09:00:00.000000Z>",
                 start_datetime: nil,
                 status: "I"
               }
             ]
      ...
      job_schedules =
        JobSchedules.list_job_schedules_by_params(%{"and" => [], "or" => [%{"job_code" => "JobSceduleDailySweep"}]})
      ...
      assert results == [
               %{
                 ...
                 status: "I",
                 function: "run",
                 job_code: "JobSceduleDailySweep",
                 module: "MateriaBatch.BatchJobs.TableSweeper",
                 name: "ジョブスケジュール日次削除",
                 params:
                   "\"MateriaBatch.JobSchedules.JobSchedule\",\"end_datetime\", 2, {\"and\": [{\"status\": \"S\"}],\"or\": [] }"
               }
             ]

      # not target job was not scheduled.
      not_target_job_schedules =
        JobSchedules.list_job_schedules_by_params(%{"and" => [], "or" => [%{"name" => "日次バッチ以外"}]})
