defmodule MateriaBatchWeb.JobScheduleControllerTest do
  ...
  @create_attrs %{
    ...
    module: "some module",
    name: "some name",
    next_check_datetime: "2010-04-17 14:00:00.000000Z",
    params: "some params",
    priority: 42,
    reschedule_period_sec: 42,
    schedule_datetime: "2010-04-17 14:00:00.000000Z",
  ...
  @update_attrs %{
    ...
    next_check_datetime: "2011-05-18 15:01:01.000000Z",
    params: "some updated params",
    priority: 43,
    reschedule_period_sec: 43,
    schedule_datetime: "2011-05-18 15:01:01.000000Z",
