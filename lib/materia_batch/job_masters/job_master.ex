defmodule MateriaBatch.JobMasters.JobMaster do
  ...
  def create_changeset(job_master, attrs) do
    job_master
    |> cast(attrs, [:job_code, :name, :module, :function, :params, :schedule_time, :error_action, :reschedule_period_sec, :priority, :schedule_period_type, :calender_type, :lock_version])
    |> validate_required([:job_code, :name, :module, :function, :schedule_time, :error_action, :reschedule_period_sec, :priority, :schedule_period_type, :calender_type])
